		...
		<form id="dame-pre-inscription-form" class="dame-form">
			...
			<div id="dame-dynamic-fields" style="display:none;">
				...
				<div id="dame-adherent-mineur-fields" style="display:none;">
					...
					<p>
						<button type="button" class="dame-copy-button" data-rep-id="1" style="background-color: #3ec0f0; color: white; border: none; padding: 8px 12px; cursor: pointer; border-radius: 5px; white-space: nowrap;"><?php _e( '✂️ Reporter les données de l\'Adhérent ✂️', 'dame' ); ?></button>
					</p>
					...
					<p>
						<button type="button" class="dame-copy-button" data-rep-id="2" style="background-color: #3ec0f0; color: white; border: none; padding: 8px 12px; cursor: pointer; border-radius: 5px; white-space: nowrap;"><?php _e( '✂️ Reporter les données de l\'Adhérent ✂️', 'dame' ); ?></button>
					</p>
