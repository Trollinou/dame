...
const DEFAULT_CONFIG = {
  ADD_TAGS: ['ion-button', 'ion-icon', 'ion-badge', 'ion-card', 'ion-card-header', 'ion-card-title', 'ion-card-subtitle', 'ion-card-content'],
  ADD_ATTR: [
    'expand', 'href', 'target', 'slot', 'color', 'name', 'fill', 
    'data-path', 'style' // data-path est utilisé pour useInternalLinks
  ]
};
